...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-[1280px] h-[400px] relative">
        <div className="w-[1280px] h-[400px] left-0 top-0 absolute bg-stone-500 bg-opacity-50" />
        <div className="left-[363px] top-[372px] absolute text-center"><span style="text-black text-xl font-normal font-['Inter']">©2023; designed with love and care by </span><span style="text-black text-xl font-normal font-['Figma Hand']">GuidanceGrove™</span></div>
        <div className="left-[188px] top-[260px] absolute text-center text-black text-[40px] font-normal font-['Lora']">Home   News   About Us   Contact Us   Our Team</div>
        <Image className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full" src="https://via.placeholder.com/100x100" alt={''} />
        <img className="w-[100px] h-[100px] left-[419px] top-[100px] absolute rounded-full" src="https://via.placeholder.com/100x100" />
        <img className="w-[100px] h-[100px] left-[590px] top-[100px] absolute rounded-full" src="https://via.placeholder.com/100x100" />
        <img className="w-[100px] h-[100px] left-[761px] top-[100px] absolute rounded-full" src="https://via.placeholder.com/100x100" />
        <img className="w-[100px] h-[100px] left-[932px] top-[100px] absolute rounded-full" src="https://via.placeholder.com/100x100" />
      </div>
    </div >
  )
}

    ...
    <div>
      ...
      <main className="bg-[#C5D5C3] flex min-h-screen flex-col items-center justify-between  ">
        ...
        <section>
          <div className="w-[1280px] h-[900px] relative">
            <form action="">
              <label htmlFor="name" className="w-[400px] h-[720px] left-[25px] top-[122px] absolute">name</label>
              <input type="text" className="w-[400px] h-[720px] left-[440px] top-[122px] absolute" />

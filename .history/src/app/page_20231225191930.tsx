  ...
  return (
    <div>
      ...
      <div className="w-[1280px] h-[400px] relative">
        ...
        <div className="left-[363px] top-[372px] absolute text-center"><span className="text-black text-xl font-normal font-['Inter']">©2023; designed with love and care by </span>
          <span className="text-black text-xl font-normal font-['Figma Hand']">GuidanceGrove™</span>
        </div>
        ...
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">a</div>
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">b</div>
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">c</div>
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">d</div>
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">e</div>
        <div className="w-[100px] h-[100px] left-[248px] top-[100px] absolute rounded-full">f</div>

      ...
      <main className="bg-[#C5D5C3] flex min-h-screen flex-col items-center justify-between  ">
        ...
        <section>
          <div className="w-[1280px] h-[900px] relative">
            <div className="w-[1280px] h-[900px] left-0 top-0 absolute bg-stone-500 bg-opacity-30" />
            <div className="w-[900px] h-[600px] left-[190px] top-[168px] absolute bg-white" />
            <div className="left-[214px] top-[171px] absolute text-black text-[50px] font-normal font-['Inter']">name: <br />email: <br />message: <br /><br /></div>
            <div className="w-[200px] h-[75px] left-[540px] top-[664px] absolute bg-orange-700 bg-opacity-80 rounded-[5px] shadow" />
            <div className="left-[582px] top-[671px] absolute text-center text-white text-[50px] font-normal font-['Inter']">send</div>
          </div>
        </section>
      </main>
      <footer className="">

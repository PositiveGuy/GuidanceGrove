  ...
  return (
    <>
      ...
      <nav className="flex fixed z-50 w-full h-20 justify-between items-center p-5 bg-black">
        ...
        {/* Burger Menu */}
        <button ref={buttonRef} className="lg:hidden cursor-pointer bg-white p-2 mr-1.5" onClick={handleMenuToggle}>
      ...
      {/* Mobilie Navbar */}
      <div ref={menuRef} className={`lg:hidden ${menuOpen ? "flex" : "hidden"}   w-full z-50 top-14 fixed transition-all duration-500 ease-in-out`}>

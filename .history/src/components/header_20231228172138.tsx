...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="flex fixed z-50 w-full h-20 items-center px-5 bg-black">
        <div className="flex justify-start flex-grow items-center space-x-3">
        ...
        <ul className="hidden lg:flex justify-center flex-grow space-x-4">
        ...
        <div className="flex justify-end flex-grow items-center space-x-3">
          <div className="hidden md:block text-white">Language menu</div>

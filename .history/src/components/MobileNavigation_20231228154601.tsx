...
export default function MobileNavigation() {
    ...
    return (
        <Navbar className='lg:hidden flex   w-full h-20 justify-between items-center p-5 bg-black fixed z-50'       >
            ...
            <div className='flex'>
                ...
                <Navbar.Collapse className='bg-white absolute top-[5rem] w-full md:block md:w-auto hidden bg-white absolute top-[5rem]'>
                    <SearchBar />

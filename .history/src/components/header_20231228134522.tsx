...
const Header = () => {
  ...
  return (
    <>
      <nav className="hidden fixed z-50 w-full md:flex justify-between items-center p-5 bg-black">
      ...
      {/*Mobile Navbar*/}
      <nav className="md:hidden fixed z-50 w-full flex justify-between items-center p-5 bg-black">
        <div className="flex items-center space-x-3">
          <img src="/Logo/guidance-grove-logo.png" alt="Guidance Grove Logo" className="h-12 w-12 rounded-full" />
      ...
      {istoggled && <MobileNavigation toggleMobileNav={toggleMobileNav} />}
    </>
  );
};

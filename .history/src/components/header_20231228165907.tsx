...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="flex fixed z-50 w-full h-20 justify-end md:justify-between md:items-center p-5 bg-black">
        ...
        <div className="flex items-center space-x-3">
          <div className="hidden md:flex">
            <div className="text-white">Language menu</div>
        ...
        {/* Burger Menu */}
        <button ref={buttonRef} className="lg:hidden cursor-pointer hover:bg-slate-800 rounded p-2 mr-1.5" onClick={handleMenuToggle}>

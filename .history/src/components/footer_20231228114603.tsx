...
const Footer = () => {
  ...
  return (
    <footer className={`p-5 bg-black shadow-inner text-center  `}>
      <div className={`flex justify-center space-x-8 mt-10 ${theme === "light" ? "bg-red-400 text-yellow-200" : "bg-amber-300 text-red-600"}`}>
        {/* Placeholder for social icons */}
        <Image src={"/SVGs/ig.svg"} width={50} height={50} alt="ig"></Image>
        <Image src={"/SVGs/fb.svg"} width={50} height={50} alt="fb"></Image>
        <Image className={`${theme === "light" ? "bg-red-400 text-yellow-200" : "bg-amber-300 text-red-600"}`} src={"/SVGs/tw.svg"} width={50} height={50} alt="tw"></Image>

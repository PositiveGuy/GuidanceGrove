        ...
        <form className="flex items-center">
            <div className="relative w-full">
                ...
                <input
                    type="search"
                    id="default-search"
                    className="block w-full h-10 pl-10 pr-20 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
